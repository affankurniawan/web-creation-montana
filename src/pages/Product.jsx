...
export default function Product() {
  ...
  const categories = ['All', 'Pens', 'Markers', 'Scissors', 'Tissue', 'Bundles', 'New Arrivals'];
  const needs = ['All', 'School', 'Office', 'Home', 'Business'];

  const products = [
    { id: 1, name: 'Montana Pro Pen Set', img: 'https://images.unsplash.com/photo-1583485088034-697b5a69fdd9?w=400&q=80', price: 'Rp 45.000', tag: 'Best Seller' },
    ...
    { id: 3, name: 'Precision Desk Organizer', img: 'https://images.unsplash.com/photo-1517842645767-c639042777db?w=400&q=80', price: 'Rp 85.000', tag: 'New Arrival' },
    ...
    { id: 7, name: 'Whiteboard Marker Box', img: 'https://images.unsplash.com/photo-1456735190827-d1262f71b8a3?w=400&q=80', price: 'Rp 65.000', tag: 'Bulk Save' },
    ...
    <main className="product-page bg-gray-50">
      ...
      <div className="proof-strip bg-black text-white py-2 text-center text-sm">
        <span className="flex items-center justify-center gap-2">
           <ShieldCheck size={16} className="text-yellow" /> Durable Quality. Fairly Priced. Built for Everyday Progress.
        </span>
      </div>
      ...
      <div className="container product-layout">
        ...
        <aside className="product-sidebar">
          <div className="search-box mb-4">
            ...
            <input type="text" placeholder="Search essentials..." />
          </div>

          <div className="filter-group mb-4">
            <h3 className="filter-header flex items-center gap-2"><Filter size={18} /> Category</h3>
          ...
          <div className="filter-group">
            <h3 className="filter-header flex items-center gap-2"><Tag size={18} /> Shop by Need</h3>
            <ul className="filter-list">
              {needs.map(need => (
                <li key={need} 
        ...
        <section className="product-main">
          ...
          <div className="product-header flex justify-between items-center mb-4">
            <h2>{activeCategory === 'All' ? 'All Essentials' : activeCategory}</h2>
            ...
            {products.map(product => (
              <div className="catalog-product-card" key={product.id}>
                ...
                <div className="product-info flex flex-col items-center text-center p-3">
                  ...
                  <button className="btn btn-outline" style={{width: '100%', padding: '0.5rem'}}>Add +</button>
                </div>
              </div>
            ))}
          </div>
