    ...
    <footer className="footer bg-black">
      <div className="container footer-container">
        <div className="footer-brand">
          <img src="/logo.png" alt="Montana Logo" style={{ height: '44px' }} />
          <p>
      ...
      <div className="container">
        <div className="footer-newsletter">
          <h4>Bergabung dengan komunitas Montana</h4>
          <p>Dapatkan info terbaru, promo eksklusif, dan tips produktivitas langsung di inbox Anda.</p>
